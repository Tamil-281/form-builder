...
export type FormBuilderAction =
  ...
  | { type: 'ADD_COLUMN_TO_NESTED_ROW'; parentRowId: string; parentColumnId: string; nestedRowId: string; column: FormColumn }
  | { type: 'ADD_FIELD'; rowId: string; columnId: string; field: FormField }
  | { type: 'ADD_FIELD_TO_NESTED_ROW'; parentRowId: string; parentColumnId: string; nestedRowId: string; columnId: string; field: FormField }
  ...
  | { type: 'REMOVE_COLUMN_FROM_NESTED_ROW'; parentRowId: string; parentColumnId: string; nestedRowId: string; columnId: string }
  | { type: 'REMOVE_FIELD'; rowId: string; columnId: string; fieldId: string }
  | { type: 'REMOVE_FIELD_FROM_NESTED_ROW'; parentRowId: string; parentColumnId: string; nestedRowId: string; columnId: string; fieldId: string }
  ...
  | { type: 'MOVE_COLUMN_IN_NESTED_ROW'; parentRowId: string; parentColumnId: string; nestedRowId: string; fromIndex: number; toIndex: number }
